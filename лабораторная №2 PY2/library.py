...
class Book:
    ...
    def __repr__(self) -> str:
        """Возвращает валидное Python-выражение для воссоздания экземпляра."""
...
class Library:
    ...
    def get_index_by_book_id(self, book_id: int) -> int:
        """
        Возвращает индекс книги с указанным id в списке книг.

        Args:
            book_id: Идентификатор искомой книги.
